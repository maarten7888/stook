...
DELETE FROM photos WHERE cook_session_id IN (
  SELECT id FROM cook_sessions WHERE user_id = 'eca5eb65-2fe6-4ee7-b827-2bae3f48ca3c'
);
...
DELETE FROM cook_sessions WHERE user_id = 'eca5eb65-2fe6-4ee7-b827-2bae3f48ca3c';
